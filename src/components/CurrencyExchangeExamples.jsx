...
const CurrencyExchangeExamples = ({ use }) => {
  ...
  return (
    <div className="shadow-[0_6px_8px_2px_rgba(0,0,0,0.2)] w-full bg-white rounded-lg dark:shadow-[0_6px_8px_2px_rgba(250,250,250,0.5)] flex flex-col items-center dark:bg-gray-700 ease-in-out duration-300 justify-center">
      <div className="bg-gray-100 w-full flex flex-col justify-center items-center rounded-t-lg p-3 gap-3 ease-in-out duration-300 dark:bg-gray-900 dark:text-gray-100">
      ...
      <div className="flex justify-between p-3 w-11/12">
        <div className="flex justify-center text-blue-700 ease-in-out duration-300 dark:text-gray-300">{`${Intl.NumberFormat(
          "en-US"
        ).format(1)} ${
          use === "rate1" ? fromCurrency.threeLetters : toCurrency.threeLetters
        }`}</div>
        <div className="flex justify-center ease-in-out duration-300 dark:text-gray-300">{`${Intl.NumberFormat(
          "en-US"
